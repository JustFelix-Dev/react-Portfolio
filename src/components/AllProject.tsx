           ...
           <motion.div variants={myVariant} initial='hidden' animate='visible' className="allProject">
             <motion.div variants={childVariant}>
                  ...
                  <a className="link" target="blank" href={'https://airbnb.felixdev.com.ng'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694427320/Github%20ReadMe%20Screenshots/Screenshot_73_hdcphh.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://react-budget-app-orpin.vercel.app/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694437857/Github%20ReadMe%20Screenshots/Screenshot_77_jff20f.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://www.scheduley.felixdev.com.ng'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694432699/Github%20ReadMe%20Screenshots/Screenshot_74_uapnm0.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://react-joke-app.vercel.app/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694440540/Github%20ReadMe%20Screenshots/Screenshot_81_ja8dcx.png" alt="icon" />
                  </a>
                     <p className="details">
                          Joke-App
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://react-service-provider-checker.vercel.app/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694438500/Github%20ReadMe%20Screenshots/Screenshot_78_jkogiy.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/CSS-Library/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694437109/Github%20ReadMe%20Screenshots/Screenshot_76_bqovtd.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://figma-to-react-rho.vercel.app/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694441350/Github%20ReadMe%20Screenshots/Screenshot_82_le6way.png" alt="icon" />
                  </a>
                     <p className="details">
                          Figma - to - React
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://printivo-clone.vercel.app/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694439497/Github%20ReadMe%20Screenshots/Screenshot_79_tmxq8d.png" alt="icon" />
                  </a>
                     <p className="details">
                          Printivo
                     </p>
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Weather-App/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694443247/Github%20ReadMe%20Screenshots/Screenshot_84_nbxpx7.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Tic-Tac-Toe/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694442284/Github%20ReadMe%20Screenshots/Screenshot_83_wduwrf.png" alt="icon" />
                  </a>
                     <p className="details">
                          Tic-Tac-Toe Game
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Quiz-App/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694447058/Github%20ReadMe%20Screenshots/Screenshot_87_uheeat.png" alt="icon" />
                  </a>
                     <p className="details">
                          Quiz Application
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Calculation-Table/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694446109/Github%20ReadMe%20Screenshots/Screenshot_86_xnrkqm.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Gmail-Clone/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694506546/Github%20ReadMe%20Screenshots/Screenshot_93_j4h9es.png" alt="icon" />
                  </a>
                     <p className="details">
                         Gmail HomePage
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Twitter-Clone/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694507135/Github%20ReadMe%20Screenshots/Screenshot_94_at9v5d.png" alt="icon" />
                  </a>
                     <p className="details">
                         Twitter HomePage
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/YouTube-Clone/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694507684/Github%20ReadMe%20Screenshots/Screenshot_95_ydcig4.png" alt="icon" />
                  </a>
                     <p className="details">
                         YouTube HomePage
                     </p>
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/JS-Calculator/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694495398/Github%20ReadMe%20Screenshots/Screenshot_89_tybuki.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Coffee-Page/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694513591/Github%20ReadMe%20Screenshots/Screenshot_97_mfzntq.png" alt="icon" />
                  </a>
                     <p className="details">
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Mosaic-Grid/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694514276/Github%20ReadMe%20Screenshots/Screenshot_98_jai3jc.png" alt="icon" />
                  </a>
                     <p className="details">
                          Mosaic Grid
                     </p>
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/WhatsApp-Web/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694514833/Github%20ReadMe%20Screenshots/Screenshot_100_oagzom.png" alt="icon" />
                  </a>
                     <p className="details">
                          WhatsApp WebPage
                     </p>
            ...
            <motion.div  variants={childVariant}  >
                  ...
                  <a className="link" target="blank" href={'https://tail-wind-e-commerce.vercel.app/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694443564/Github%20ReadMe%20Screenshots/Screenshot_85_xr4cch.png" alt="icon" />
                  </a>
                     <p className="details">
                         E-Commerce Page
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Ludo-Game/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694515286/Github%20ReadMe%20Screenshots/Screenshot_101_nzwbnl.png" alt="icon" />
                  </a>
                     <p className="details">
                          Ludo Game - UI
                     </p>
            ...
            <motion.div  variants={childVariant} >
                  ...
                  <a className="link" target="blank" href={'https://justfelix-dev.github.io/Chess-Board/'}>
                     <img src="https://res.cloudinary.com/dljgkzwfz/image/upload/q_50/v1694515040/Github%20ReadMe%20Screenshots/Screenshot_6_g56otn.png" alt="icon" />
                  </a>
                     <p className="details">
                         ChessBoard - UI
                     </p>
